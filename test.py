...
d4cnn.conv.test_D4ConvRR(image, 15, 3, stride=2)
d4cnn.conv.test_D4ConvRR(image, 15, 3, stride=2, padding=1)
...
d4cnn.conv.test_D4ConvIR(image, 15, 3, stride=2)
d4cnn.conv.test_D4ConvIR(image, 15, 3, stride=2, padding=1)
...
d4cnn.conv.test_D4ConvRI(image, 15, 3, stride=2)
d4cnn.conv.test_D4ConvRI(image, 15, 3, stride=2, padding=1)
